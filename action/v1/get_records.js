  ...
  input: {
    ...
    properties: {
      object: {
        title: "object",
        type: "string",
        enum: ["Address", "Customer", "Country", "Currency", "Device", "Inventory", "KPIMetric", "Location", "Personnel", "Product", "Purchase Order", "Purchase Order Item", "Sales Order", "Sales Order Item", "Service Request"], // Define the dropdown options here
